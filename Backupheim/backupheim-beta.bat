...
set "worldcloud="C:Program files x(86)\Steam\userdata\%steamid%\892970\remote\worlds""
set "charcloud="C:Program files x(86)\Steam\userdata\%steamid%\892970\remote\characters""
